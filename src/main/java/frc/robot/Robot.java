...
public class Robot extends TimedRobot {
  ...
  private final Victor s_leftMotor = new Victor(4);
  private final Victor c_Motor = new Victor(5);
  private final Victor s_rightMotor = new Victor(6);
  private final Victor i_Motor = new Victor(7);
  ...
  public void teleopPeriodic() {
    ...
    s_leftMotor.set(speed);
    s_rightMotor.set(speed);
    c_Motor.set(speed);
    i_Motor.set(speed);
  }
}
